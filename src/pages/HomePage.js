        ...
        <>
            ...
            <TwoColumn>
                ...
                <Column>
                    ...
                    <p>Bij sommige disk-gebruikers leegt de disk zichzelf bij elk toiletbezoek. Dit wordt auto-dumping genoemd.
                        Op die manier kun je de disk wel 12 uur dragen als je veel menstrueert.</p>

                    <h3>Disk uitkoken</h3>
                    <p>Aangeraden wordt om minimaal één keer per cyclus (ervoor of erna) je disk vijf minuten uit te koken. Dit kan in
            ...
            <TwoColumnWithImg img={cupsOnRackImg}
                ...
                <p>Een disk kun je maar op een manier vouwen, erg simpel (zeker als je cups gewend bent, die hebben veel
                    vouwen!). Je menstruatiedisk vouw je door de zijkanten in te drukken. Op die manier heb je een platte
                    ovaal.</p>
                <h2>Automatisch legen van de disk? (Automdumping)</h2>
                <p>Een voordeel die disk-gebruikers ervaren is dat de disk automatisch losschiet als je op de wc zit, waardoor die zich leegt in de wc.
                    Vaak moet je hem erna weer even terugklemmen achter je schaambeen. Ideaal als je veel menstrueert, want dan kan je er echt 12 uur mee doen!</p>
                <p>Als de disk losschiet op andere momenten, is dit een lekkage en geen auto-dump. Probeer de disk iets hoger vast te klemmen.</p>
            </TwoColumnWithImg>
