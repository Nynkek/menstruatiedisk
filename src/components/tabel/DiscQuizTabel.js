            ...
            <YellowContentBox>
                ...
                <form>
                    <label>
                        ...
                        Ik heb een hoge baarmoedermond. <span className="small-txt">Hoger dan 5,5cm.</span>
                    </label><br/>
                    <label>
                    ...
                    <label>
                        ...
                        Ik heb een lage baarmoedermond. <span className="small-txt">Hij zit lager dan 4,5cm.</span>
                    </label><br/>
                    <label>
