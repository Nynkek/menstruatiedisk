        ...
        <div className="footer-container">
            ...
            <footer className="footer">
                ...
                <div className="footer-txt">
                    <p>Deze website is een zuster-site van <a href="https://cupkiezer.nl" target="_blank" rel="noreferrer">Cupkiezer</a></p>
                    <p>De site is gemaakt door <a href="https://nynkek.nl/" target="_blank" rel="noreferrer">Nynkek</a> omdat weinig onafhankelijke informatie over menstruatiedisks in het
