export const discChooseData = {
    title: "Hoe kies je een disk?",
    rows: [
        {
            title: "Hoe kies je een menstruatiedisk?",
            content: `
<p>Menstruatiedisks komen in verschillende breedtes, hardheden en modellen. Er is niet één "one size fits all"-disk, helaas. 
Een disk die voor een ander goed werkt, hoeft niet bij jou goed te werken.</p>
